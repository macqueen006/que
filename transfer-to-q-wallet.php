                ...
                <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                    ...
                    <div class="widget dashboard-container my-adslist">
                        <table class="table table-responsive product-dashboard-table">
                            <tbody>
                            <?php q_wallet_transfer(); ?>
                            <form method="POST">
                                <h3 class="text-center">Q-WALLET TOP-UP</h3>
                                <p class="text-center">Please Type in The amount you want to transfer to your Q-Wallet.</p>
                                <input style="height:32px;" type="text" id="ticket-amount" class="form-control text-center" name="ticket-amount">
                                <br>
                                <center>
                                    <button type="submit" onclick="javascript: return confirm('Are you sure you want to Transfer ₦' + document.getElementById('ticket-amount').value + ' to your Q-Wallet?');" class="btn btn-dark">Transfer</button>
                                </center>
                            </form>
                            </tbody>
                        </table>
