...
$activequery = "  SELECT * FROM users WHERE user_active=1 ";
$activeresult = Query($activequery);
confirm($activeresult);
$activeCount = row_count($activeresult);

$onlinequery = "  SELECT * FROM online_status WHERE start=1 AND end=0 ";
$onlineresult = Query($onlinequery);
confirm($onlineresult);
$onlineCount = row_count($onlineresult);
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="card my-3 my-lg-0">
                    ...
                    <div class="card-body bg-gray text-center">
                        <h5 class="card-title">John Trinity</h5>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="card my-3 my-lg-0">
                    <img class="card-img-top" src="images/team/team1.jpg" class="img-fluid w-100" alt="Card image cap">
                    <div class="card-body bg-gray text-center">
                        <h5 class="card-title">Chuks Ikechukwu</h5>
                        <p class="card-text">CTO / Chief Technological Officer</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6">
                <div class="card my-3 my-lg-0">
                    <img class="card-img-top" src="images/team/team1.jpg" class="img-fluid w-100" alt="Card image cap">
                    <div class="card-body bg-gray text-center">
                        <h5 class="card-title">John Vanessa</h5>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 my-lg-0 my-3">
                <div class="counter-content text-center bg-light py-4 rounded">
                    ...
                    <span class="counter my-2 d-block" data-count="<?php echo $activeCount; ?>">0</span>
        ...
        ?>
            <div class="col-lg-3 col-sm-6 my-lg-0 my-3" >
                <div class="counter-content text-center bg-light py-4 rounded" >
                    <i class="fa fa-smile-o d-block" ></i >
                    <span class="counter my-2 d-block" data-count="<?php echo $onlineCount; ?>">0</span >
