		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="content-block">
					<h1>QuestionMark Technologies </h1>
					<p>Making things happen with simple lasting solutions <br> everyday in local communities around the world</p>
					<div class="short-popular-category-list text-center">
						<h2>Popular FORUM Categories</h2>
						<ul class="list-inline">
                            <?php
                                $query = " SELECT * FROM popular_categories ORDER BY id DESC ";
                                $result = Query($query);
                                confirm($result);
							...
							<li class="list-inline-item">
								<a href="forum.php?CatId=<?php echo $row['cat_id']; ?>"><i class="<?php echo $row['icon']; ?>"></i> <?php echo $row['title']; ?></a></li>
                            <?php } ?>
<!--							<li class="list-inline-item">-->
<!--								<a href="category.html"><i class="fa fa-scissors"></i> Sports</a>-->
<!--							</li>-->
<!--							<li class="list-inline-item">-->
<!--								<a href="category.html"><i class="fa fa-book"></i> Eduction</a>-->
<!--							</li>-->
<!--							<li class="list-inline-item">-->
<!--								<a href="category.html"><i class="fa fa-star-o"></i> Celebrities</a>-->
<!--							</li>-->
<!--							<li class="list-inline-item">-->
                            ...
                            <form method="POST">
                                <div class="form-row">
                                    <div class="form-group col-md-10">
                                        <input type="email" name="news-email" class="form-control my-2 my-lg-1 text-center" id="inputtext4" placeholder="Enter your email to join our newsletter">
                                    </div>
                                    <div class="form-group col-md-2 align-self-center">
                                        <button type="submit" name="newsBtn" class="btn btn-outline-dark">Join</button>
                                    </div>
                                </div>
                            </form>
                        </div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="section-title">
					<h2>Coming Soon</h2>
					<p>Ads Listing Feature. Grow and Expose your Business to the Public.</p>
				</div>
			</div>
		</div>
		<div class="row">
			<!-- offer 01 -->
			<div class="col-lg-12">
				<div class="trending-ads-slide" style="background-color: black;opacity: 90%;padding: 50px;">
                    ...
                    <div class="col-md-3" style="padding: 50px;">
                        ...
                        <div class="image d-flex justify-content-center">
                            <h3 style="color: white;">Minutes</h3>
                        </div>
                    </div>
                    <div class="col-md-3" style="padding: 50px;">
                        <div class="image d-flex justify-content-center">
					...
					<div class="col-lg-3 offset-lg-0 col-md-5 offset-md-1 col-sm-6 col-6">
						<div class="category-block">
                            ...
                            <ul class="category-list" >
                                ...
                                <li><a href="category.html">Parlours <span>33</span></a></li>
                            </ul>
                        </div>
					</div> <!-- /Category List -->
					<!-- Category list -->
