                ...
                <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                    ...
                    <div class="widget dashboard-container my-adslist">
                        <table class="table product-table table-hover">
                            ...
                            $query = " SELECT * FROM q_money_transaction WHERE user='$dbUsername' ORDER BY id DESC ";
                            $result = Query($query);
                            $count = row_count($result);

                            $count = ceil($count / $per_page);

                            $sql = "SELECT * FROM q_money_transaction WHERE user='$dbUsername' ORDER BY id DESC LIMIT $page_1, $per_page ";
                            $check = Query($sql);
                            ...
                            while($row = fetch_data($check))
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="product-item"><?php echo ' ₦' .$Amount; ?></td>
                                    <td class="product-item"><?php print date("r", strtotime($Date)); ?></td>
                                </tr>
                        ...
                        <div class="float-right">
                            ...
                            <label for="">Q-Wallet </label> <input type="radio" name="check" id="qwallet" checked>
                            <label for="">Wallet </label> <input type="radio" name="check" onclick="window.location.href = 'wallet.php';" id="wallet">
                        </div>
                    </div>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                ...
                                if($page > 1){
                                    ?>
                                    <li class="page-item">
                                        <a class="page-link" href="q_wallet.php?page=<?php echo $page-1; ?>" aria-label="Previous">
                                ...
                                {
                                    if($i == $page){
                                        echo "<li class='page-item active'><a class='page-link' href='q_wallet.php?page={$i}'>{$i}</a></li>";
                                    }else{
                                        echo "<li><a class='page-link' href='q_wallet.php?page={$i}'>{$i}</a></li>";
                                    }
                                }
                                ...
                                if($i>=$page_1){
                                    ...
                                    ?>
                                    <li class="page-item">
                                        <a class="page-link" href="q_wallet.php?page=<?php echo $page+1; ?>" aria-label="Next">
