                ...
                <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                    ...
                    <div class="widget dashboard-container my-adslist">
                        <table class="table table-responsive product-dashboard-table">
                            <tbody>
                            <?php check_deposit_amount(); ?>
                            <form method="POST">
                                <h3 class="text-center">WALLET DEPOSIT TOP-UP</h3>
                                <p class="text-center">Please Type in the amount you want to deposit Below To Top Up.</p>
