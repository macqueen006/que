                ...
                <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                    ...
                    <div class="widget dashboard-container my-adslist">
                        <table class="table table-responsive product-dashboard-table">
                            ...
                            <?php load_ticket(); ?>
                                <form method="POST">
                                    <h3 class="text-center">Q-TICKET WALLET TOP-UP</h3>
                                    <p class="text-center">Please Type in Your 16 Digit Q-Ticket Code Below To Top Up.</p>
                                    <input style="height:32px;" type="text" class="form-control text-center" name="ticket-code">
                                    <br>
                                    <center>
